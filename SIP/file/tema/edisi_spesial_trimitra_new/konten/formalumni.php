...
<div class="row">
	<div class="col-md-12"><h3>Form Alumni</h3></div>
	<div class="col-md-12">Silahkan mengisi data alumni pada form dibawah ini, diharapkan data yang anda masukkan adalah data yang valid.</div>
</div><br/>
...
<div class="row">    
	...
	<div class="col-sm-4"><input type="text" id="tanggal" name="tanggal_lahir" class="form-control"><br /></div>
</div>
<div class="row"> 
