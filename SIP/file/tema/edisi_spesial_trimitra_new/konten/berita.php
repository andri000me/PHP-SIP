<div class="row">
	<div class="col-md-12">
		...
		?>
		<?php echo "<h3 class=heading><a href='?p=detberita&id=$r[id_berita]'>$r[judul_berita]</a></h3><br>
		...
		echo "<p><img src='images/$r[gambar_kecil]' width='175px' style='float:left; margin: 0 0 0 10px; padding: 10px; class='thumbnail'>$isi...<a href='?p=detberita&id=$r[id_berita]'>Baca selengkapnya...</a></p><br>";}
		else {
