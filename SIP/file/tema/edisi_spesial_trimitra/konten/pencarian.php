...
if ($hitun > 0){
while ($r=mysql_fetch_array($pencaria)){
echo "<h4><a style='font-family:Bree Serif' href='?p=agenda'>$r[judul_agenda]</a></h4>";
}}
...
if ($hitung<1 AND $hitun<1 AND $hitu<1){echo "<h3 style='font-family:Sans-Serif' class='text-center'>Tidak ada kata yg cocok</h3>";}
?>
    </div>
</div>