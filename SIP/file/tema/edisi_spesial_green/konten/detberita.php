...
<?php
 echo "
<small>Diposting pada: <a href='?p=tglberita&tgl=$r[tanggal_posting]'>".tgl_indo($r[tanggal_posting])."</a>, oleh : <a href='?p=userberita&user=$r[s_username]'>$r[nama_lengkap_users]</a>, Kategori: <a href='?p=katberita&id=$r[id_kategori]'>$r[nama_kategori]</a></small>
...
<ul style="list-style: none; padding-left: 5px;">
	...
	<p><b><?php echo "<a style='color:#F6BD27;' href='#'>$k[nama_komentar]</a>";?></b><br><small><?php echo tgl_indo($k[tanggal_komentar]);?></small></p>
