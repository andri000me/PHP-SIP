...
<div id='Back-to-top'>
<img alt='Scroll to top' src='file/tema/edisi_spesial_green/styles/img/backtotop.png'/>
</div>
		...
		<form method="POST" action="?p=pencarian" class="form-horizontal" role="form">
          <div style="padding:0px 15px;" class="form-group has-default has-feedback visible-xs-block">
           <div class="input-group">
            ...
            <span class="input-group-addon"><input type="image" src="file/tema/edisi_spesial_green/styles/img/cari1.png" alt="Submit" name="btn_cari" title="Cari" width="20"/></span>
           </div>
          </div>
        </form></div>
...
<div class="col-md-8">
<div class="container-fluid">
<div class="row"><?php include"file/tema/edisi_spesial_green/menu.php"?></div>
  ...
  <?php include"file/tema/edisi_spesial_green/footeratas.php"?>
  
  <div class="row" id="footer"><?php include"file/tema/edisi_spesial_green/footer.php"?></div>
</div>
</div>
<div class="col-md-2">
</div>
