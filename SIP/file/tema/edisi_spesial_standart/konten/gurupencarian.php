...
<div class="panel-heading"><h3 style="font-family:Bree Serif;">Hasil Pencarian Guru <?php echo "$ns[isi_pengaturan]";?> dengan kata kunci "<?php echo "$cari";?>"</h3></div>
...
<?php
$no=1;
$gurustaff=mysql_query("SELECT * FROM sh_guru_staff WHERE  posisi='guru' AND nama_gurustaff LIKE '%$cari%' OR posisi='guru' AND nip LIKE '%$cari%' ORDER BY nama_gurustaff ASC");
