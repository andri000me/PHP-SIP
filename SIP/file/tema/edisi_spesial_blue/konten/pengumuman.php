...
<table class="table">
	<tr class="info"><th colspan="3"><a href=""><?php echo "$r[judul_pengumuman]";?></a></th></tr>
	<tr><td><b>Tanggal Posting</b></td><td width="3px">:</td><td><?php echo tgl_indo($r[tanggal_pengumuman]);?></td></tr>
