...
<div id="gallery" class="panel panel-primary">
<div class="panel-heading"><h3 style="font-family:Bree Serif;">Album Galeri <a href=""><?php echo "$ns[isi_pengaturan]";?></a></h3></div>
...
<?php echo "<small>".tgl_indo($r[tanggal_album])."</small>";?><br>
<?php
