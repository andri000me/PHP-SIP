     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			?>
				...
				<div class="carousel-caption">
				  <h4><a href="?p=detberita&id=<?php echo $data['id_berita'];?>#art" style="color:#D1D931;"><?php echo $data['judul_berita']?></a></h4>
				  <p class="hidden-xs" style="color:#fff;"><?php echo "$isi...<a href='?p=detberita&id=$data[id_berita]#art' >Baca selengkapnya...</a>";?></p>
				</div>
			  </div>
			  ...
			  <div class="item">
				...
				<div class="carousel-caption">
				  <h4><a href="?p=detberita&id=<?php echo $dat['id_berita'];?>#art" style="color:#D1D931;"><?php echo $data['judul_berita']?></a></h4>
				  <p class="hidden-xs" style="color:#fff;"><?php echo "$isi...<a href='?p=detberita&id=$dat[id_berita]#art' >Baca selengkapnya...</a>";?></p>
				</div>
			  </div>
			  ...
			  <?php $headli=mysql_query("SELECT * FROM sh_berita WHERE
				...
				<div class="carousel-caption">
				  <h4><a href="?p=detberita&id=<?php echo $da['id_berita'];?>#art" style="color:#D1D931;"><?php echo $data['judul_berita']?></a></h4>
				  <p class="hidden-xs" style="color:#fff;"><?php echo "$isi...<a href='?p=detberita&id=$da[id_berita]#art' >Baca selengkapnya...</a>";?></p>
				</div>
			  </div>
...
?>		
		...
		<a style="margin-left:10px;" href="?p=detprofil&id=<?php echo $r['nama_siswa'];?>#popup"> <?php echo $r['nama_siswa'];?></a><br/><p style="margin-left:60px;color:#989898;"><small><?php echo tgl_indo($r['tanggal_posting']);?><br/><?php echo "<a  style='margin-left:0px;' href='?p=katmading&id=$r[id_mading_kategori]'>$r[nama_mading_kategori]</a>";?></small></p>
		</div>
...
echo "<p>$isi...<a href='?p=detmading&id=$r[id_mading]'>Baca selengkapnya...</a></p><br/>";
	...
	//Menghilangkan Constant $_SESSION
	$siswa_session = isset($_SESSION['siswa']);
	$ortu_session = isset($_SESSION['orangtua']);
	$guru_session = isset($_SESSION['guru']);
