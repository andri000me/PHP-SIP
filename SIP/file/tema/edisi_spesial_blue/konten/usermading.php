...
<div class="panel-heading"><h3 style="font-family:Bree Serif;" class="panel-title">Mading Karya <?php echo isset($_GET['user']);?></h3></div>
...
<?php	$batas= 5;
		...
		$get_user = isset($_GET['user']);
		$tampil2 = mysql_query ("SELECT * FROM sh_mading WHERE nama_siswa='$get_user' AND status_terbit='1'");
		$jmldata = mysql_num_rows($tampil2);
		$jmlhal = ceil($jmldata/$batas);
		$mading =mysql_query("SELECT * FROM sh_mading WHERE nama_siswa='$get_user' AND status_terbit='1' ORDER BY sh_mading.id_mading DESC LIMIT $posisi, $batas");
...
?>		
		...
		<a style="margin-left:10px;" href=""> <?php echo $r[nama_siswa];?></a><br/><p style="margin-left:60px;"><?php echo tgl_indo($r[tanggal_posting]);?><br/><small><?php echo "<a  style='margin-left:0px;' href='?p=katmading&id=$r[id_mading_kategori]'>$r[nama_mading_kategori]</a>";?></small></p>
		</div>
