<div id="berita" class="panel panel-primary">
      <div class="panel-heading">
       <h3 style="font-family:Bree Serif;" class="panel-title">Berita</a></h3>
      </div>
...
<small>Diposting pada: <a href='?p=tglberita&tgl=$r[tanggal_posting]'>".tgl_indo($r['tanggal_posting'])."</a>, oleh : <a href='?p=userberita&user=$r[s_username]'>$r[nama_lengkap_users]</a>, Kategori: <a href='?p=katberita&id=$r[id_kategori]'>$r[nama_kategori]</a>
, Komentar : $jml_komen
</small><br>";
