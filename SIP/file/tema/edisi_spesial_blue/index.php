...
<head>			<?php
				...
				?>
				<link rel="shortcut icon" href="images/<?php echo $l[isi_pengaturan];?>"/>
...
s1.async=true;
s1.src='https://embed.tawk.to/584777728a20fc0cac4dedfb/default';
s1.charset='UTF-8';
...
<div id='Back-to-top'>
<img alt='Scroll to top' src='file/tema/edisi_spesial_blue/styles/img/backtotop.png'/>
</div>
		...
		<form method="POST" action="?p=pencarian" class="form-horizontal" role="form">
          <div style="padding:0px 15px;" class="form-group has-default has-feedback visible-xs-block">
           <div class="input-group">
            ...
            <span class="input-group-addon"><input type="image" src="file/tema/edisi_spesial_blue/styles/img/cari1.png" alt="Submit" name="btn_cari" title="Cari" width="20"/></span>
           </div>
          </div>
        </form></div>
...
<div class="col-md-10">
<div class="container-fluid">
<div class="row"><?php include"file/tema/edisi_spesial_blue/menu.php"?></div>
  ...
  <?php include"file/tema/edisi_spesial_blue/footeratas.php"?>
  
  <div class="row" id="footer"><?php include"file/tema/edisi_spesial_blue/footer.php"?></div>
</div>
</div>
<div class="col-md-1">
</div>
