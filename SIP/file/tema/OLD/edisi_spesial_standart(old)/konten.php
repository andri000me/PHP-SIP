...
?>		
		...
		<?php } /*?>
			...
			<?php
			$sambutan=mysql_query("SELECT * FROM sh_info_sekolah WHERE id_info='14'");
			$sm=mysql_fetch_array($sambutan) or die ("ERRO DB SQL".mysql_error());
			?>
		...
		<div class="clear"></div>
			...
			<div id="kecil" style="width:298px">
			 <img src="file/tema/edisi_spesial_standart/css/img/gallery.jpg" width="280" height="50"/>
			<?php
		...
		<div id="statis">
			<img src="file/tema/edisi_spesial_standart/css/img/statistik.png">
