...
<!-- awal konten -->
			...
			<div id="headline">
				<!-- <div id="slides"> -->
					<div class="slides_container">
						...
						?>
						<div class="slide">
							<a  href="<?php echo "?p=detberita&id=$sb[id_berita]"; ?>" title=""><img src="images/<?php echo $sb[gambar_kecil]?>"   alt="Slide 1"></a>
	...
	<!-- akhir headline  -->
		...
		<!--awal tabs -->
		<ul class="tabs">
			<li><a href="#berita">Artikel Sekolah</a></li>
			<li><a href="#mading">Mading Siswa</a></li>
			<li><a href="#kategori">Kategori</a></li>
			<li><a href="#komentar">Komentar</a></li>
			<li><a href="#agenda">Agenda Sekolah</a></li>
		</ul>
				  <!-- akhir tabs -->
		...
		<div id="lebarTab">
				...
				<div id="berita" class="tab_content">
					...
					<p style="margin-top: 19px;">
						...
						echo "<p><img src='images/$b[gambar_kecil]' width='90px' height='70px' style='float:left; margin: -7px 10px 0 0; padding: 3px; background: #fff; border: 1px solid #dcdcdc'>$isi...<a href='?p=detberita&id=$b[id_berita]'>Baca selengkapnya...</a></p><br>";}
						else {
				...
				<div id="mading" class="tab_content">
					...
					?>
						<li>
						<!-- Judul Mading  -->
							<p style="margin-top: -5px"><a href="<?php echo "?p=detmading&id=$b[id_mading]";?>">
						...
						echo "<p><img src='images/$b[gambar_mading]' width='100px'  height ='100px' style='float:left; 
							...
							padding: 3px; background: #fff; border: 1px solid #dcdcdc'>$isi...<a href='?p=detmading&id=$b[id_mading]'>Baca selengkapnya...</a></p><br><br/><br/><br/>";}
						else {
		...
		<div class="clear"></div>
			<div id="galeri">
			<h3 style="color:#2ecc71">Galeri Terbaru</h3>
			<?php
			...
			<!-- div id statis -->
			<div id="statis">
				<h1 id="statis-h1">Statistik Web</h1>
				<table id="statistik" style="margin: 0 0 20px 0" >
				<?php
				...
				?>
				<tr bgcolor="#27ae60">
					<td id="se" style="padding: 5px 0px 5px 10px" ><?php echo "$totalhits";?></td>
					<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/statis.png"></td>
					<td style="padding: 5px 0px 5px 10px"><b>Total Hits Halaman</b></td>
				</tr>
				<tr bgcolor="#27ae60"><td style="padding: 5px 0px 5px 10px"><?php echo "$totalpengunjung";?></td>
					<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/statis.png"></td>
					<td style="padding: 5px 0px 5px 10px"><b>Total Pengunjung</b></td>
				</tr>
				<tr bgcolor="#27ae60"><td style="padding: 5px 0px 5px 10px"><?php echo "$hits[kunjunganhariini]";?></td>
					<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/statis.png"></td>
					<td style="padding: 5px 0px 5px 10px"><b>Hits Hari Ini</b></td>
				</tr>
				<tr bgcolor="#27ae60"><td style="padding: 5px 0px 5px 10px"><?php echo "$pengunjung";?></td>
					<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/statis.png"></td>
					<td style="padding: 5px 0px 5px 10px"><b>Pengunjung Hari Ini</b></td>
				</tr>
				<tr bgcolor="#27ae60"><td style="padding: 5px 0px 5px 10px"><?php echo "$pengunjungonline";?></td>
					<td style="padding: 5px 0px 5px 10px"><img src="file/tema/edisi_spesial_gambar/css/img/statis.png"></td>
...
echo "<p><img src='images/$r[gambar_kecil]' width='410px' height='200px' style='float:left; margin: 5px 10px 0 0; padding: 10px; background: #fff; border: 1px solid #dcdcdc'><br/>$isi...<a href='?p=detberita&id=$r[id_berita]'>Baca selengkapnya...</a></p><br>";}
else {
...
?>
<!--Menampilkan akhir hasil pencarian berita-->
...
<?php break; ?>
<!--Menampilkan akhir berita berdasarkan kategori-->
...
<?php break; ?>
<!--Menampilkan akhir berita berdasarkan penulis-->

<!--Menampilkan berita berdasarkan tglberita-->
<?php case "tglberita":?>
<div id="konten">
<div id="lebar">
<?php
...
<?php break; ?>
<!--Menampilkan akhir berita berdasarkan tglberita-->
...
?>
<!--Menampilkan akhir detail berita-->
...
<table>
	...
	<textarea name="komentar" style="width: 200px; height: 75px;"></textarea></td></tr>
...
<!-- awal mading karya tulis -->
<?php case "madingKaryaTulis":?>
<!-- awal id konten -->
...
<!-- awal mading karya Seni -->
<!-- awal mading karya Seni -->
<!-- awal mading karya Seni -->
<!-- awal mading karya Seni -->
<?php case "madingKaryaSeni":?>
<!-- awal id konten -->
...
<!--Menampilkan hasil pencarian mading-->
<?php case "pencarianmading":
$cari = trim($_POST['cari']);
$cari = htmlentities(htmlspecialchars($cari), ENT_QUOTES);
?>
<div id="konten">
...
<h3>Hasil Pencarian dengan kata kunci <a href="">"<?php echo "$cari"?>"</a></h3><br><br>
<?php
$pencarian =mysql_query("SELECT * FROM sh_mading, sh_mading_kategori, sh_siswa WHERE 
						sh_mading.id_kategori=sh_mading_kategori.id_mading_kategori AND 
						sh_mading.nama_siswa=sh_siswa.nama_siswa AND status_terbit='1' AND 
						sh_mading.judul_mading LIKE '%$cari%' ORDER BY id_kategori DESC");
...
?>
<?php echo "<h4><a href='?p=detmading&id=$r[id_mading]'>$r[judul_mading]</a></h4><br>
<small>Diposting pada: <a href='?p=tglmading&tgl=$r[tanggal_posting]'>$r[tanggal_posting]</a>, oleh : <a href='?p=usermading&user=$r[nama_siswa]'>$r[nama_lengkap_users]</a>, Kategori: <a href='?p=katmading&id=$r[id_mading_kategori]'>$r[nama_mading_kategori]</a>
, Komentar : $jml_komen
</small><br>";
						$isi_mading = strip_tags($r[isi_mading]); 
						$isi = substr($isi_mading,0,450);
...
<!--Menampilkan mading berdasarkan kategori-->
<?php case "katmading":?>
...
<?php
$mading=mysql_query("SELECT * FROM sh_mading, sh_mading_kategori, sh_siswa WHERE sh_mading.id_kategori=sh_mading_kategori.id_mading_kategori AND sh_mading.nama_siswa=sh_siswa.nama_siswa AND status_terbit='1' AND sh_mading.id_kategori='$_GET[id]' ORDER BY id_mading DESC");
$cek_mading=mysql_num_rows($mading);
...
, Komentar : $jml_komen
						...
						$isi = substr($isi_mading,0,450);
if ($r[gambar_mading] != 'no_image.jpg'){
echo "<p><img src='images/$r[gambar_mading]' width='175px' height='175px' style='float:left; margin: 5px 10px 0 0; padding: 10px; background: #fff; border: 1px solid #dcdcdc'>$isi...<a href='?p=detmading&id=$r[id_mading]'>Baca selengkapnya...</a></p><br>";}
else {
echo "<p>$isi...<a href='?p=detmading&id=$r[id_mading]'>Baca selengkapnya...</a></p><br>";
}}	
}
...
<!--Menampilkan mading berdasarkan penulis-->
<?php case "usermading":?>

<div id="konten">
<div id="lebar">
<?php
$nama_user=mysql_query("SELECT * FROM sh_siswa WHERE nama_siswa='$_GET[user]'");
$nu=mysql_fetch_array($nama_user);
$hitung_user_mading=mysql_query("SELECT * FROM sh_mading WHERE status_terbit='1' AND nama_siswa='$_GET[user]'");
$jml_mading_user=mysql_num_rows($hitung_user_mading);
?>
<h3>Ada <?php echo $jml_mading_user?> mading yang ditulis oleh <u><?php echo $nu[nama_siswa]?></u></h3><br>

<?php
$mading =mysql_query("SELECT * FROM sh_mading, sh_mading_kategori, sh_siswa WHERE sh_mading.id_kategori=sh_mading_kategori.id_mading_kategori AND sh_mading.nama_siswa=sh_siswa.nama_siswa AND status_terbit='1' AND sh_mading.nama_siswa='$_GET[user]' ORDER BY id_mading DESC");
$cek_mading=mysql_num_rows($mading);
...
<b>Data mading yang ditulis oleh <?php echo $nu[nama_siswa]?> belum tersedia</b>
<?php } ?>
</div>
</div>
<?php break; ?>
...
<!--Menampilkan mading berdasarkan tgl-->
<?php case "tglmading":?>
...
$tgl=mysql_fetch_array($hitung_tgl_mading);
?>
<h3>Ada <?php echo $jml_mading_tgl?> mading yang ditulis pada <u><?php echo $tgl[tanggal_posting]?></u></h3><br>

<?php
$mading =mysql_query("SELECT * FROM sh_mading, sh_mading_kategori, sh_siswa WHERE sh_mading.id_kategori=sh_mading_kategori.id_mading_kategori AND sh_mading.nama_siswa=sh_siswa.nama_siswa AND status_terbit='1' AND sh_mading.tanggal_posting='$_GET[tgl]' ORDER BY id_mading DESC");
$cek_mading=mysql_num_rows($mading);
...
<!--Menampilkan detail mading-->
<?php case "detmading": ?>
<?php
$pencarian =mysql_query("SELECT * FROM sh_mading, sh_mading_kategori, sh_siswa WHERE sh_mading.id_kategori=sh_mading_kategori.id_mading_kategori AND sh_mading.nama_siswa=sh_siswa.nama_siswa AND status_terbit='1' AND id_mading='$_GET[id]' ORDER BY id_mading DESC");
$r=mysql_fetch_array($pencarian);
?>
<div id="konten">
<div id="lebar">
...
<h3>Tinggalkan Komentar</h3>
<br>
<form method="POST" action="kontenweb/insert_komentar_mading.php" id="formkomentar" name="formkomentar">
...
<input type="text" class="cari" name="cari"><input type="submit" class="tombol-cari"  style="margin-bottom: 20px" value="Cari">
</form>
...
if ($_POST['jk']=="S") {
$gurustaff=mysql_query("SELECT * FROM sh_guru_staff, sh_mapel WHERE sh_guru_staff.id_mapel=sh_mapel.id_mapel AND posisi='guru' ORDER BY nama_gurustaff ASC");
} Else $gurustaff=mysql_query("SELECT * FROM sh_guru_staff, sh_mapel WHERE sh_guru_staff.id_mapel=sh_mapel.id_mapel AND jenkel='$_POST[jk]'  AND posisi='guru' ORDER BY nama_gurustaff ASC");
...
if ($_POST['jk']=="S"){
$gurustaff=mysql_query("SELECT * FROM sh_guru_staff, sh_jabatan WHERE sh_guru_staff.id_jabatan=sh_jabatan.id_jabatan  AND posisi='staff' ORDER BY nama_gurustaff ASC");
}Else $gurustaff=mysql_query("SELECT * FROM sh_guru_staff, sh_jabatan WHERE sh_guru_staff.id_jabatan=sh_jabatan.id_jabatan  AND posisi='staff' AND jenkel='$_POST[jk]' ORDER BY nama_gurustaff ASC");
...
if($_POST['jk']=="S"){
$siswa=mysql_query("SELECT * FROM sh_siswa, sh_kelas WHERE sh_siswa.id_kelas=sh_kelas.id_kelas  AND status_siswa='1' ORDER BY nama_siswa ASC");
}Else $siswa=mysql_query("SELECT * FROM sh_siswa, sh_kelas WHERE sh_siswa.id_kelas=sh_kelas.id_kelas  AND status_siswa='1' AND jenkel='$_POST[jk]' ORDER BY nama_siswa ASC");
$hitung=mysql_num_rows($siswa);
if ($hitung > 0){
while($r=mysql_fetch_array($siswa)){
?>
...
if($_POST['jk']=="S"){
$alumni=mysql_query("SELECT * FROM sh_siswa WHERE status_siswa='0' ORDER BY nama_siswa ASC");
} Else $alumni=mysql_query("SELECT * FROM sh_siswa WHERE status_siswa='0' AND jenkel='$_POST[jk]' ORDER BY nama_siswa ASC");
