...
<table class="table">
   ...
   <div class="row">
	...
	<div class="row">
	  ...
	  <div class="col-sm-6 alert alert-default"><label class="control-label"><b>Darimanakah anda mengetahui PSB ONLINE <a href=""><?php echo "$ns[isi_pengaturan]"?></a></b></label></div>
	</div>
