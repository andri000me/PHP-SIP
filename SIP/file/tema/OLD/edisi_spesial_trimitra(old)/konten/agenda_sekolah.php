...
<div class="panel-heading"><h3>Agenda <a href=""><?php echo "$ns[isi_pengaturan]";?></a></h3></div>
...
<table class="table">
	...
	<tr><td><b>Tanggal Agenda</b></td><td width="3px">:</td><td><?php echo "$r[tanggal_agenda]";?></td></tr>
