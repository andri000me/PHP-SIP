...
<!-- Style Camera 01 -->
	<?php
		$no   =1;
		$cctv = mysql_query("SELECT * FROM sh_cctv , sh_kelas , sh_siswa , sh_ortu 
							WHERE sh_cctv.id_kelas = sh_kelas.id_kelas AND
...
<div class="titleCctv">CCTV ON <?php echo "$c[nama_kelas]";?> <hr/></div>
<div class="clear"></div>
<div class="cctv">
...
<div class="clear"></div>
	<div class="row">
<?php 
	$cctvP = mysql_query("SELECT * FROM sh_cctv,sh_kelas WHERE sh_cctv.id_kelas=sh_kelas.id_kelas AND status =0 AND aktif_ortu =1 ORDER BY id_cctv");
	while($cc=mysql_fetch_array($cctvP)){ ?>
		...
		<div class="col-md-2">
			<div class="thumbnail">
				...
				<a href="?p=cctvpublic&id=<?php echo "$cc[id_cctv]";?>"><img src="https://cdn1.iconfinder.com/data/icons/google_jfk_icons_by_carlosjj/512/youtube.png" width="30px"/></a>
				</div>
