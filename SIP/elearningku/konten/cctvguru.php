...
<div class="panel-heading"><h3 class="panel-title">Monitor CCTV Keseluruhan</h3></div>
...
<div class="row">
	<?php
		$no   =1;
		$cctv = mysql_query("SELECT * FROM sh_cctv , sh_kelas WHERE sh_cctv.id_kelas = sh_kelas.id_kelas");
...
<div class="col-md-4">
    <div class="alert alert-info">CCTV ON <?php echo "$c[nama_kelas]";?> </div>
        <div class="panel panel-info">
            <a href="?p=detailcctv&id=<?php echo $c['id_cctv']?>"><img class="img-responsive" src="<?php echo "$c[alamat_cctv]";?>" alt="real-time video feed"  /></a>
        </div>
