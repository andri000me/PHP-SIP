...
<!-- Pencarian Berdasarkan Kelas -->
       ...
       <div class="table-responsive">
		...
		<?php
				...
				$hadir=$_POST['hadir'];
				$no=1;
				$absen=mysql_query("SELECT scan_date, n_induk, siswa_name, kelas_name, jadwal_name, jam_masuk, scan_in, terlambat, jam_pulang, scan_out, status_hadir
                                    FROM result_proc
                                    WHERE result_proc.status_hadir ='$hadir' and result_proc.siswa_id = '$ot[id_siswa]' ORDER BY `result_proc`.`scan_date` DESC");
