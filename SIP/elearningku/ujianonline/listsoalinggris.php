...
<img src=\"images/images_admin/icon_admin_user.png\" align=\"absmiddle\" class=\"img_title\" /> Daftar Soal Kemampuan Bahasa Inggris
<a href=\"inputsoalinggris.php\"><img src=\"images/images_admin/img_admin_add.png\" align=\"absmiddle\" border=\"0\" /></a>
</div>
";
...
$sql	 = mysql_query("select * from tsoal2 order by soalid ASC LIMIT $posisi,$batas");
...
<a href=\"admin-home.php?page=listsoalinggris&act=edit&id=$r[soalid]\" class=\"action\">Edit</a>

<img src=\"images/images_admin/img_admin_delete.png\" align=\"absmiddle\" class=\"img_del\" />
<a href=\"admin-home.php?page=listsoalinggris&act=delete&id=$r[soalid]\" class=\"action\" onClick=\"return warning();\">Delete</a>
...
$jmldata=mysql_num_rows(mysql_query("SELECT * FROM tsoal2"));
...
case "edit":
$msql = mysql_query("select * from tsoal2 where soalid='$_GET[id]'");
$rr   = mysql_fetch_array($msql);

echo"
<div id=\"content\" style=\"height:650px\">
<div id=\"title_content\">
<img src=\"images/images_admin/icon_admin_user.png\" align=\"absmiddle\" class=\"img_title\" /> Edit Soal Inggris
</div>
";
...
case "delete":
mysql_query("DELETE FROM tsoal2 WHERE soalid='$_GET[id]'");
echo "<meta http-equiv='refresh' content='0; url=admin-home.php?page=listsoalinggris'>"; 
break;
