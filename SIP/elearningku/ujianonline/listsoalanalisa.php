<?php
session_start();
if(empty($_SESSION["guru"]) || empty($_SESSION["guru"])) {
...
<img src=\"images/images_admin/icon_admin_user.png\" align=\"absmiddle\" class=\"img_title\" /> Daftar Soal Kemampuan Analisa
<a href=\"inputsoalanalisa.php\"><img src=\"images/images_admin/img_admin_add.png\" align=\"absmiddle\" border=\"0\" /></a>
</div>
";
...
<div style=\"width:150px\" align=\"left\">Soal</div>
<div style=\"width:200px\" align=\"center\">Pilihan Jawaban</div>
<div style=\"width:100px\" align=\"center\">Kunci Jawban</div>
<div style=\"width:150px\" align=\"center\">Action</div>
</div>
";
...
$sql	 = mysql_query("select * from tsoal order by soalid ASC LIMIT $posisi,$batas");
while($r = mysql_fetch_array($sql)){

echo "
<div id=\"content_data\">
<div style=\"width:10px\">$r[soalid].</div>
<div style=\"width:150px\" align=\"left\">$r[pertanyaan]</div>
<div style=\"width:200px\" align=\"left\">A. $r[pilihan_a]<br><br>
B. $r[pilihan_b]<br><br>
C. $r[pilihan_c]<br><br>
D. $r[pilihan_d]<br><br>

</div>
<div style=\"width:120px\" align=\"center\">$r[jawaban]</div>
<div style=\"width:150px\" align=\"center\">

<img src=\"images/images_admin/img_admin_edit.png\" align=\"absmiddle\" class=\"img_edit\" />
<a href=\"admin-home.php?page=listsoalanalisa&act=edit&id=$r[soalid]\" class=\"action\">Edit</a>

<img src=\"images/images_admin/img_admin_delete.png\" align=\"absmiddle\" class=\"img_del\" />
<a href=\"admin-home.php?page=listsoalanalisa&act=delete&id=$r[soalid]\" class=\"action\" onClick=\"return warning();\">Delete</a>
...
$jmldata=mysql_num_rows(mysql_query("SELECT * FROM tsoal"));
...
case "edit":
$msql = mysql_query("select * from tsoal where soalid='$_GET[id]'");
$rr   = mysql_fetch_array($msql);

echo"
<div id=\"content\" style=\"height:650px\">
<div id=\"title_content\">
<img src=\"images/images_admin/icon_admin_user.png\" align=\"absmiddle\" class=\"img_title\" /> Edit Soal Analisa
</div>
";
...
case "delete":
mysql_query("DELETE FROM tsoal WHERE soalid='$_GET[id]'");
echo "<meta http-equiv='refresh' content='0; url=admin-home.php?page=listsoalanalisa'>"; 
break;
