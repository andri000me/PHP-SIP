...
?>
	...
	<div class="row">
       <div class="col-lg-12">
          <h3 class="page-header"><strong> Setting Modem </strong></h3>
        </div>
            <!-- /.col-lg-12 -->
      </div>
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example">
 ...
 <tr> <td> <input type="submit" name="submit1" value="Simpan" class="btn btn-default"> </td> </tr>
 </table>
</form>
...
echo "<table class='table table-striped table-bordered table-hover' id='dataTables-example' >";
echo "<tr><th>ID Phone</th><th>Port</th><th>Connection</th><th>Send</th><th>Receive</th><th width='40%'>Action</th></tr>";
$count = 0;
for($i=1; $i<=$maxmodem; $i++)
{
	if (is_file('smsdrc'.$i))
...
echo "</td>";
echo "<td width='2%'>&nbsp;";
echo "</td><td width='58%' valign='top'>";
