...
// fungsi untuk melakukan koneksi ke database mysql kedua
function koneksi3_buka() {
    mysql_select_db(DB3_NAMA,mysql_connect(DB3_HOST,DB3_USER,DB3_PASSWORD));
}
 
// fungsi untuk menutup koneksi ke database mysql kedua
function koneksi3_tutup() {
    mysql_close(mysql_connect(DB3_HOST,DB3_USER,DB3_PASSWORD));
}
?>