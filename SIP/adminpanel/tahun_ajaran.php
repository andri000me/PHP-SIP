...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		...
		<?php } ?>
			...
			<div class="menu"><div class="isimenuSms"><a href="/websch/gammu/index.php?module=home" target="_blank">SMS - GATEWAY</a></div></div>
			<?php } ?>
		...
		<div id="kanan"><!--Awal id kanan-->
					...
					<?php include "aplikasi/tahun_ajaran_data.php"; ?>
