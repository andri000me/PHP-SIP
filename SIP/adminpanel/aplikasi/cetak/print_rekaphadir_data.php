...
echo " <div class=\"sd_left\">
		...
		<h2 align=center>Laporan Hadir Siswa.</h2>
		<p align=center>Berikut Ini Laporan Hadir Siswa.</p>
		...
		$absen = mysql_query("SELECT DISTINCT siswa.siswa_name as nama, result_proc.n_induk , result_proc.nisn , result_proc.kelas_name , result_proc.tahun_ajaran , result_proc.semester  ,
									  ...
									  AND result_proc.siswa_name = siswa.siswa_name AND result_proc.kelas_name = '$_GET[kelas]' AND result_proc.n_induk = '$_GET[noinduk]'");
