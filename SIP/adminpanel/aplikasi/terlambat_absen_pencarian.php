...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			...
			<div class="menuhorisontalaktif-ujung"><a href="terlambat.php">Rekap Terlambat Absen</a></div>
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_pencarian_terlambat.php?noinduk=<?php echo $_POST['noinduk'] ?>&kelas=<?php echo $_POST['kelas'] ?>' target='_blank'>Tampilan Cetak </a>
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$absen=mysql_query("SELECT DISTINCT siswa.siswa_name as nama , result_proc.n_induk , result_proc.nisn , result_proc.kelas_name , result_proc.tahun_ajaran , result_proc.semester ,
									(SELECT COUNT(terlambat)
										...
										FROM result_proc , siswa WHERE result_proc.terlambat AND result_proc.siswa_name = siswa.siswa_name AND result_proc.kelas_name = '$_POST[kelas]' AND result_proc.n_induk = '$_POST[noinduk]' ");
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="9"><font color="red"><b>DATA RINCIAN TERLAMBAT ABSENSI SISWA BELUM TERSEDIA / DATA KELAS & NO INDUK TIDAK SESUAI</b></font></td></tr>
