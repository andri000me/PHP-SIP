...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_terlambat.php' target='_blank'>Tampilan Cetak
		...
		<table class="tabel" id="results">
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="9"><font color="red"><b>DATA RINCIAN TERLAMBAT ABSENSI SISWA BELUM TERSEDIA</b></font></td></tr>
    ...
    //--></script>
		...
		case "pencarian":
			include "aplikasi/terlambat_absen_pencarian.php";
		}
		?>
