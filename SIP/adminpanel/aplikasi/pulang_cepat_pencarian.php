...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_pulangcepat_data.php?noinduk=<?php echo $_POST['noinduk'] ?>&kelas=<?php echo $_POST['kelas'] ?>' target='_blank'>Tampilan Cetak </a>
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$absen=mysql_query("SELECT DISTINCT siswa.siswa_name as nama, result_proc.n_induk , result_proc.nisn , result_proc.kelas_name , result_proc.tahun_ajaran , result_proc.semester ,
									  ...
									  FROM result_proc , siswa WHERE result_proc.pulang_cepat AND result_proc.siswa_name = siswa.siswa_name AND result_proc.kelas_name = '$_POST[kelas]' AND result_proc.n_induk = '$_POST[noinduk]' ");
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="9"><font color="red"><b>DATA RINCIAN PULANG CEPAT ABSENSI SISWA BELUM TERSEDIA / DATA KELAS & NO INDUK TIDAK SESUAI</b></font></td></tr>
