...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
				$no=1;
				$bukutamu=mysql_query("SELECT * FROM sh_mading WHERE status='1' ORDER BY id_mading DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
					<div class="hapusdata"><a href="<?php echo "$database?pilih=terima&untukdi=hapus&id=$b[id_mading]";?>">hapus</a></div>
					<div class="editdata"><a href="<?php echo "?pilih=edit&id=$b[id_mading]";?>">edit</a></div>
					<div class="bataldata"><a href="<?php echo "$database?pilih=terima&untukdi=tolak&id=$b[id_mading]";?>">tolak</a></div>
