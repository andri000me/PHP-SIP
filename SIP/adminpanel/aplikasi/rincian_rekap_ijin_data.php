...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_rekap_ijin.php' target='_blank'>Tampilan Cetak
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$absen=mysql_query("SELECT DISTINCT siswa.siswa_id as id , siswa.siswa_name as nama , result_proc.n_induk , result_proc.nisn , result_proc.kelas_name , result_proc.tahun_ajaran , result_proc.semester  ,
									 ...
									 FROM result_proc , siswa where result_proc.siswa_name = siswa.siswa_name");
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="9"><font color="red"><b>DATA RINCIAN IZIN ABSENSI SISWA BELUM TERSEDIA</b></font></td></tr>
    ...
    //--></script>
		...
		case "pencarian":
			include "aplikasi/rekap_ijin_pencarian.php";
		}
		?>
