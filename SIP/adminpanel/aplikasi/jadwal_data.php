<?php
$database="aplikasi/database/jadwal.php";
switch($_GET['pilih']){
default: ?>
...
<div class="isikanan"> <!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<tr class="tabel"><td class="tabel" colspan="8"><font color="red"><b>DATA JADWAL PELAJARAN BELUM TERSEDIA</b></font></td></tr>
			<?php } ?>
		</table>
		...
		case "tambah":
			include "aplikasi/jadwal_tambah.php";
		break;
		
		case "kelas":
			include "aplikasi/jadwal_kelas.php";
		break;
		
		case "ta":
			include "aplikasi/jadwal_ta.php";
		break;
		
		case "edit":
		    include "aplikasi/jadwal_edit.php";
		}
		?>
