...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			...
			<div class="menuhorisontalaktif-ujung"><a href="rekap_tidak_hadir.php">Rekap Tidak Hadir</a></div>
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_tidakhadir_pencarian.php?noinduk=<?php echo $_POST['noinduk'] ?>&kelas=<?php echo $_POST['kelas'] ?>' target='_blank'>Tampilan Cetak </a>
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$absen=mysql_query("SELECT DISTINCT siswa.siswa_name as nama, result_proc.n_induk , result_proc.nisn , result_proc.kelas_name , result_proc.tahun_ajaran , result_proc.semester  ,
									  (SELECT COUNT(status_hadir ='Tidak Hadir')
									  FROM result_proc
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="9"><font color="red"><b>DATA RINCIAN TIDAK HADIR ABSENSI SISWA BELUM TERSEDIA / DATA KELAS & NO INDUK TIDAK SESUAI</b></font></td></tr>
