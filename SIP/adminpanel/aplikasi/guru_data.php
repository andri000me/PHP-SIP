...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<table class="tabel" id="results">
			...
			<?php
			$no=1;
			$guru=mysql_query("SELECT * FROM sh_guru_staff WHERE posisi='guru' ORDER BY id_gurustaff DESC");
			...
			<tr class="tabel">
				...
				<td class="tabel">
						<?php
						// MAPEL VIEW
						$mapel=mysql_query("SELECT * from sh_mapel_guru where sh_mapel_guru.id_gurustaff ='$g[id_gurustaff]' ");
						while($m=mysql_fetch_array($mapel)){
						?>
						<a href="<?php echo "mata_pelajaran.php?pilih=edit&id=$m[id_mapel]";?>"><?php echo "$m[nama_mapel]";?></a>,
					<?php } ?>
				</td>
