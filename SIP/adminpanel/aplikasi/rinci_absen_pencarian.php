...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_absen_pencarian_harian.php?noinduk=<?php echo $_POST['noinduk'] ?>&awal=<?php echo $_POST['awal'] ?>&akhir=<?php echo $_POST['akhir'] ?>' target='_blank'>Tampilan Cetak </a>
		...
		<table class="tabel" id="results">
			...
			<?php
				...
				$no=1;
				$absen=mysql_query("SELECT hari,scan_date,result_proc.n_induk,tahun_ajaran,result_proc.siswa_name,kelas_name,jadwal_name,jam_masuk,scan_in,terlambat,jam_pulang,scan_out,pulang_cepat,status_hadir FROM result_proc , siswa where result_proc.n_induk ='$noinduk' and result_proc.scan_date between '$tanggal_awal' and '$tanggal_akhir' AND result_proc.siswa_name = siswa.siswa_name order by result_proc.scan_date desc");
