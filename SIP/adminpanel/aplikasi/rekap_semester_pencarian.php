...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="atastabel" style="margin:5px">
			...
			<td class="isiankanan" width="250px"><a href='../adminpanel/aplikasi/cetak/print_rekap_semester_pencarian.php?noinduk=<?php echo $_POST['noinduk'] ?>&kelas=<?php echo $_POST['kelas'] ?>' target='_blank'>Tampilan Cetak </a>
		...
		<table class="tabel" id="results">
			...
			?>
			<tr class="tabel"><td class="tabel" colspan="11"><font color="red"><b>DATA RINCIAN SEMESTER ABSENSI SISWA BELUM TERSEDIA / DATA KELAS & NO INDUK TIDAK SESUAI</b></font></td></tr>
