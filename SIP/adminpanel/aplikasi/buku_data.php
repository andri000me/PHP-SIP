		...
		<table class="tabel" id="results">
			...
			<tr class="tabel">
				...
				<td class="tabel">
					...
					<?php if($b[status]=='1'){ ?>
					<div class="batal123"><a href="<?php echo "$database?pilih=bukutamu&untukdi=tolak&id=$b[id_bukutamu]";?>">tolak</a></div>
					<?php }
					else { ?>
					<div class="terima123"><a href="<?php echo "$database?pilih=bukutamu&untukdi=terima&id=$b[id_bukutamu]";?>">terima</a></div>
					<?php } ?>
				</td>
			</tr>
			<?php
