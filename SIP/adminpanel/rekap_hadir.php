...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		...
		<div id="kanan"><!--Awal id kanan-->
					...
					<?php include "aplikasi/rincian_rekap_hadir_data.php"; ?>
												
							<!-- PopUP Windows -->
							<div id="popup">
								<div class="window">
									<a href="#" class="close-button" title="Close">X</a>
									  <h2> Detail Tanggal Kehadiran </h2>
										<hr/>
											...
											<tr bgcolor="#CCCCCC">
											  ...
											  <td width="170">Tanggal</td>
												...
												/*Pengaturan Paging */
												  ...
												  $page_query=mysql_query("select COUNT(scan_date) from result_proc where n_induk = $nid and status_hadir = 'Hadir' ");
												  $pages = ceil(mysql_result($page_query, 0) / $per_page);
												  $page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
												  $start = ($page - 1) * $per_page;
												 /*------------------*/
												$detail = mysql_query("select scan_date from result_proc where n_induk = $nid and status_hadir = 'Hadir' Limit $start, $per_page "); 
