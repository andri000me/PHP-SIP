...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		...
		<?php if($_SESSION['leveluser']=='Super Admin' or $_SESSION['leveluser']=='adminmading'){ ?>
		...
		<?php if($_SESSION['leveluser']=='Super Admin' or $_SESSION['leveluser']=='Admin Panel'){ ?>
			<div class="menu"><div class="isimenuCCTV aktif"><a href="cctv.php">CCTV</a></div></div>
		<?php } ?>
		...
		<div id="kanan"><!--Awal id kanan-->
					...
					<?php include "aplikasi/cctv_data.php"; ?>
